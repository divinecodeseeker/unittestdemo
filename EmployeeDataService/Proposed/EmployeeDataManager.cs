...
namespace AppliedUnitTesting.DataService.Proposed
{
    public class EmployeeDataManager
    {
        IEmployeeDataAccessor dataAccessor;
        ...
        public EmployeeDataManager(IEmployeeDataAccessor employeeDataAccessor)
        {
